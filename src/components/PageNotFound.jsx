...
function PageNotFound() {
  return (
    <>
        ...
        <div class="text-center bg-black h-[100vh] flex flex-col items-center justify-center ">
          <p class="text-base font-semibold text-indigo-500">404</p>
          <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-500 sm:text-5xl">
            Page not found
          </h1>
          ...
          <div class="mt-10 flex items-center justify-center gap-x-6">
            ...
            <Link to="#" class="text-sm font-semibold text-gray-500">
